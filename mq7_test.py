...
# adapted from sandboxelectronics.com/?p=165 by https://tutorials-raspberrypi.com/configure-and-read-out-the-raspberry-pi-gas-sensor-mq-x/
# READAPTED by Abanoub Sargious- TFG: Gen. mapa d emissions amb UAS
...
class MQ():
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.adc = MCP3008()
        self.COCurve = [1.699,0.114,-0.744]  # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg50, lg1.3), point2: (lg4000,  lg0.05)
        print("By Abanoub Sargious - TFG: Gen. mapa d emissions amb UAS...")        
        print("Calibrating...")
